    ...
    <div class="row display-flex">
      ...
      <div class="col-md-8 hd-bg-white main-menu-responsive">
        <div class="main-menu">
          <div class="nav">
            <ul>
              <li class="nav-item {{ Helper::check_active(['home_page']) }}"><a href="{{ route('home_page') }}"
                  title="{{ __('Trang Chủ') }}">
                  <span class="fas fa-home"></span>
                  {{ __('Trang Chủ') }}</a>
              </li>
              <li class="nav-item {{ Helper::check_active(['about_page']) }}"><a href="{{ route('about_page') }}"
                  title="{{ __('Giới Thiệu') }}">
              ...
              <li class="nav-item {{ Helper::check_active(['contact_page']) }}"><a href="{{ route('contact_page') }}"
                  title="{{ __('Liên Hệ') }}">
                  <span class="fas fa-id-card"></span>
                  {{ __('Liên Hệ') }}</a>
              </li>
              <li class="nav-item {{ Helper::check_active(['show_cart']) }}"><a href="{{ route('show_cart') }}"
                  title="{{ __('Giỏ Hàng') }}">                      
          ...
          <div class="accout-menu">
            ...
            <div class="not-logged-menu">
              <ul>
                <li class="menu-item {{ Helper::check_active(['login']) }}"><a href="{{ route('login') }}"
                    title="{{ __('Đăng Nhập') }}">
                    <span class="fas fa-user"></span>
                    {{ __('Đăng Nhập') }}</a>
                </li>
                <li class="menu-item {{ Helper::check_active(['register']) }}"><a href="{{ route('register') }}"
                    title="{{ __('Đăng Ký') }}">
              ...
              <ul>
                <li
                  ...
                  <ul class="dropdown-menu">
                    @if(Auth::user()->admin)
                    <li><a href="{{ route('admin.dashboard') }}"><i class="fas fa-tachometer-alt"></i> Quản Lý
                        Website</a></li>
                    @else
                    <li class="{{ Helper::check_active(['orders_page', 'order_page']) }}"><a
                        href="{{ route('orders_page') }}"><i class="fas fa-clipboard-list"></i> Quản Lý Đơn Hàng</a>
                    </li>
                    <li class="{{ Helper::check_active(['show_user', 'edit_user']) }}"><a
                        href="{{ route('show_user') }}"><i class="fas fa-user-cog"></i> Quản Lý Tài Khoản</a></li>
                    @endif
    ...
    <div class="mb-menu-top-footer">
      ...
      <div class="mb-menu-action">
        <a href="{{ route('register') }}" class="btn btn-warning">
          <i class="fas fa-key"></i> Đăng Kýyyy
        </a>
      </div>
    </div>
    @else
  ...
  <div class="mobile-main-menu-middle">
    ...
    <div class="mb-menu-middle-body">
      <ul>
        ...
        <li
          ...
          <div id="item-child-collapse" class="collapse">
            <ul>
              @foreach($producers as $producer)
              <li class="{{ Helper::check_param_active('producer_page', $producer->id) }}"><a
                  href="{{ route('producer_page', ['id' => $producer->id]) }}" title="{{ $producer->name }}">{{
                  $producer->name }}</a></li>
              @endforeach
            </ul>
          </div>
        ...
        <li class="mb-nav-item {{ Helper::check_active(['contact_page']) }}"><a href="{{ route('contact_page') }}"
        ...
        <li class="mb-nav-item {{ Helper::check_active(['orders_page', 'order_page']) }}"><a
            href="{{ route('orders_page') }}"><span class="fas fa-clipboard-list"></span> Đơn Hàng</a></li>
        @endif
      </ul>
    </div>
  </div>
