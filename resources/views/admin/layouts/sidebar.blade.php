<aside class="main-sidebar">
  ...
  <section class="sidebar">
    ...
    <ul class="sidebar-menu" data-widget="tree">
      ...
      <li class="{{ Helper::check_active(['admin.producer.index', 'admin.producer.new', 'admin.producer.edit']) }}"><a href="{{ route('admin.producer.index') }}"><i class="fa fa-sliders" aria-hidden="true"></i> <span>Quản Lý Hãng</span></a></li>
