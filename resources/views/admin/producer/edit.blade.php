...
<form action="{{ route('admin.producer.update', ['id' => $producer->id]) }}" method="POST" accept-charset="utf-8" enctype="multipart/form-data">
  @csrf
      ...
      <div class="row">
        <div class="col-md-9">
          <div class="form-group">
            ...
            <input type="text" name="name" class="form-control" id="title" placeholder="Tên nhà sản xuất" value="{{ old('name') ?: $producer->name }}" autocomplete="off">
          </div>
          <div class="form-group">
