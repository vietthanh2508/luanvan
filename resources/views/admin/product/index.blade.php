        ...
        <div class="row">
          ...
          <div class="col-md-7 col-sm-6 col-xs-6">
            <div class="btn-group pull-right">
              <a href="{{ route('admin.product.index') }}" class="btn btn-flat btn-primary" title="Refresh"
        ...
        <table id="product-table" class="table table-hover" style="width:100%; min-width: 985px;">
          <thead>
            <tr>
              ...
              <th data-width="60px">Hãng Sản Xuất</th>
              <th data-width="60px">Tên sản phẩm + Hãng sản xuất</th>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                ...
                {{-- {{url('storageimages/products')}}/{{$product->image}} --}}
                <div
                  style="background-image: url('{{ Helper::get_image_product_url($product->image) }}'); padding-top: 100%; background-size: contain; background-repeat: no-repeat; background-position: center;">
                </div>
              </td>
              <td>
                <a class="text-left" href="{{ route('product_page', ['id' => $product->id]) }}"
                  title="{{ $product->name }}">{{ $product->sku_code }}</a>
              </td>
              <td>
                <a class="text-left" href="{{ route('product_page', ['id' => $product->id]) }}"
              ...
              <td>{{$product->name}} {{ $product->producer->name }}</td>
              <td>{{ $product->OS }}</td>
