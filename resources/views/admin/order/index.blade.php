        ...
        <table id="order-table" class="table table-hover" style="width:100%; min-width: 1024px;">
          <thead>
            <tr>
              ...
              <th data-width="30px">Trạng Thái</th>
              <th data-width="30px">Yêu cầu hủy đơn</th>
              <th data-orderable="false" data-width="140px">Tác Vụ</th>
            </tr>
          </thead>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                <a href="{{ route('admin.user_show', ['id' => $order->user->id]) }}" class="text-left"
              ...
              <td>
                @if( $order->request_cancel==1 && $order->status!=-1 )
                <span class="label label-danger" style="font-size:13px">Có yêu cầu hủy</span>
                @else
                <span class="label label-default" style="font-size:13px">Không có yêu cầu hủy</span>
                @endif
              </td>
              <td>
                <div class="btn-group">
                  ...
                  <ul class="dropdown-menu" role="menu">
                    <li>
                      <a href="{{route('admin.orderTransaction',['process',$order->id])}}"><i class="fa fa-ban">
                        </i>Đang Vận Chuyển</a>
                    </li>
                    <li>
                      <a href="{{route('admin.orderTransaction',['success',$order->id])}}"><i class="fa fa-ban"> </i>Đã
                        Giao Hàng</a>
                    </li>
                    <li>
                      <a href="{{route('admin.orderTransaction',['cancel',$order->id])}}"><i class="fa fa-ban">
                        </i>Hủy</a>
                    </li>
                  </ul>
