...
@section('content')
  ...
  <div class="site-login">
      ...
      <div class="login-social">
        ...
        <div class="row">
          <div class="col-md-6">
            <a href="{{ route('auth.facebook') }}" title="Facebook" class="btn btn-defaule"><i class="fab fa-facebook-square"></i> Facebook</a>
          </div>
          <div class="col-md-6">
            <a href="{{ route('auth.google') }}" title="Google" class="btn btn-defaule"><i class="fab fa-google"></i> Google</a>
          </div>
        </div>
      </div>
